...
export default function Section1() {
  return (
    <section className="min-h-screen md:mx-6 mx-3 flex flex-col md:flex-row items-center justify-between p-4 md:p-8 lg:p-12 relative overflow-hidden rounded-2xl">
